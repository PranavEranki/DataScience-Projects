...
It also will contain some folders for learning different modules - for example, the learning CV2 folder. These are not projects, but a collection of scripts I used for learning the language. Still, almost all of the scripts are project themed and can be downloaded and used.
